...
public class CoreConstant {
	...
	public static final String DATAX_JOB_TASKMESSGAE_PROJECTID = "job.taskMessgae.projectId";

	public static final String DATAX_JOB_TASKMESSGAE_TASKINSTANCEID = "job.taskMessgae.taskInstanceId";

	public static final String DATAX_JOB_TASKMESSGAE_PROCESSID = "job.taskMessgae.processId";

	public static final String DATAX_JOB_TASKMESSGAE_PROCESSINSTANCEID = "job.taskMessgae.processInstanceId";
