...
public class Engine {
    ...
    public void start(Configuration allConf, JobStatistics jobStatistics) throws IOException {
    ...
    public static String filterJobConfiguration(final Configuration configuration) {
        ...
        //去除流程的基本信息
        jobConfWithSetting.remove("taskMessgae");
    ...
    public static void entry(final String[] args) throws Throwable {
        ...
        //jobcontent
        jobStatistics.setJobContent(configuration.get(CoreConstant.DATAX_JOB_CONTENT).toString());
        //-----------------------------------------把流程相关信息写入jobStatistics里-------------------------------------------------
        if(configuration.get(CoreConstant.DATAX_JOB_TASKMESSGAE_PROJECTID)!=null&&!"".equals(configuration.get(CoreConstant.DATAX_JOB_TASKMESSGAE_PROJECTID))){
            jobStatistics.setProjectId(Long.valueOf(String.valueOf(configuration.get(CoreConstant.DATAX_JOB_TASKMESSGAE_PROJECTID))).longValue());
        }
        if(configuration.get(CoreConstant.DATAX_JOB_TASKMESSGAE_TASKINSTANCEID)!=null&&!"".equals(configuration.get(CoreConstant.DATAX_JOB_TASKMESSGAE_TASKINSTANCEID))){
            jobStatistics.setTaskInstanceId(Long.valueOf(String.valueOf(configuration.get(CoreConstant.DATAX_JOB_TASKMESSGAE_TASKINSTANCEID))).longValue());
        }
        if(configuration.get(CoreConstant.DATAX_JOB_TASKMESSGAE_PROCESSID)!=null&&!"".equals(configuration.get(CoreConstant.DATAX_JOB_TASKMESSGAE_PROCESSID))){
            jobStatistics.setProcessId(Long.valueOf(String.valueOf(configuration.get(CoreConstant.DATAX_JOB_TASKMESSGAE_PROCESSID))).longValue());
        }
        if(configuration.get(CoreConstant.DATAX_JOB_TASKMESSGAE_PROJECTID)!=null&&!"".equals(configuration.get(CoreConstant.DATAX_JOB_TASKMESSGAE_PROJECTID))){
            jobStatistics.setProcessInstanceId(Long.valueOf(String.valueOf(configuration.get(CoreConstant.DATAX_JOB_TASKMESSGAE_PROCESSINSTANCEID))).longValue());
        }
        ...
        if (jsonFileMatcher.find()) {
            String jsonFileName = jsonFileMatcher.group(1);
